...
function displayTask(task) {
    ...
    taskCard.innerHTML = `
        <div class="card__label">
            <h3 class="card__label_title">${title}</h3>
        ...
        <div class="card__body">
            <p class="card__body_text">${text}</p>
        </div>`;
    ...
    selector.taskText.style.height = '50px';
